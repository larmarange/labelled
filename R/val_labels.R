...
#' @param value A named vector for \code{val_labels} (see \code{\link[haven]{labelled}}) or a character string
...
#'   using the same syntax as \code{value} in `val_labels(df) <- value`.
#' @note
