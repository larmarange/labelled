...
- fix in
  ...
  LeonidasZhak)
- fix in
  [`update_labelled.labelled()`](https://larmarange.github.io/labelled/reference/update_labelled.md)
...
- argument `user_na_to_na` has been added to
  [`to_factor.data.frame()`](https://larmarange.github.io/labelled/reference/to_factor.md)
...
- `user_na_to_na` argument has been added to
  [`to_character.haven_labelled()`](https://larmarange.github.io/labelled/reference/to_character.md)
...
- [`to_factor()`](https://larmarange.github.io/labelled/reference/to_factor.md),
  [`to_character()`](https://larmarange.github.io/labelled/reference/to_character.md)
  and
  [`to_labelled.factor()`](https://larmarange.github.io/labelled/reference/to_labelled.md)
