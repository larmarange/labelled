...
If you are using the `%>%` operator, you can use the functions `set_variable_labels`, `set_value_labels` and `add_value_labels`.
...
```{r}
df <- df %>%
  set_value_labels(s2 = c(Yes = 1, Unknown = 9))
val_labels(df$s2)
