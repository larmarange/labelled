...
In base **R**, missing values are indicated using the specific value `NA`. **Regular NAs** could be used with any type of fector (double, integer, character, factor, Date, etc.).

Other statistical softwares have implemented ways to differentiate several types of missing values.
