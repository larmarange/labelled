...
[`vignette("look_for")`](https://larmarange.github.io/labelled/dev/articles/look_for.md)
...
d [%\>%](https://magrittr.tidyverse.org/reference/pipe.html)
generate_dictionary()
[%\>%](https://magrittr.tidyverse.org/reference/pipe.html) to_gt()
[%\>%](https://magrittr.tidyverse.org/reference/pipe.html)
gt::[tab_header](https://gt.rstudio.com/reference/tab_header.html)(gt::[md](https://gt.rstudio.com/reference/md.html)("\*\*Variable
dictionary\*\*"))
