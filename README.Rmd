...
1. Functions are intented to support `labelled` metadata structures only.
   However, `foreign_to_labelled` allows to convert metadata from `foreign` package to `labelled`.
...
## Note: it would also have been possible to define directly the missing values with labelled
